$(document).ready(function() {
    ...
    var questions = [
    {
        ...
        choices: ["30 July 1980", "31 July 1980", "30 July 1981", "31 July 1981"],
        choicesAnswer: 1
    },
    {
        question: "What is Harry's middle name?",
        choices: ["Peter", "James", "Albus","Hames"],
        choicesAnswer: 1
    },
    {
    ...
    {
        question: "What do Rick and his group call the Which grade is Harry awarded for his History of Magic O.W.L. exam?",
        choices: ["E","P","A","D"],
        choicesAnswer: 3
    },
    {
        question: "What is T-Dogs real Who is called as a witness in Harry’s Wizengamot trial?",
        choices: ["Dumbledore","Mrs.Pigg","Dobby","Ron"],
        choicesAnswer: 1
    },
    {
        question: "Where is Rick originally What is the first wand Harry holds at Ollivanders?",
        choices: ["Mahogany","Spurce","Malpe","Beechwood"],
        choicesAnswer: 3
    }];
